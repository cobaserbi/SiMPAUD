          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3 class="text-primary">Tambah  Super User</h3>
              </div>
                            ...
                            <div class="x_content">
                                    <form class="" action="<?php echo base_url('superUser/proses_tambah_superuser'); ?>" method="post" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="nik" placeholder="" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="username" placeholder="" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
